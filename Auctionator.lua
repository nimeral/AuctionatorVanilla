...
function Auctionator_AddSellPanel ()
	...
	--Maybe default inheritation would be better
...
function Auctionator_AddSellTab ()
	...
	local n = 4;--C'mon, normal guys have 3 tabs!
...
function Auctionator_UpdateRecommendation ()
	...
	if (basedata) then
		...
		local newStartPrice = calcNewPrice(round(newBuyoutPrice *0.99)); --let none be lost!
